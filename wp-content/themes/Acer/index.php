...
get_header();?>
            ...
            <div class="container">
                <div  class="row">
                    <div class="col-xs-12 col-md-6 col-sm-6 overcoming">
                         <h4 class="d-black lh-33 h-sep"><?php the_field('who_we_are_title', 2);?></h4>
                        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/red_line.png">
                        <p class="lh-28 mt-50 fz-15"><?php the_field("who_we_are_content", 2);?></p>
                ...
                <div class="row mt-70">
                    ...
                    <div class="col-xs-12 col-md-3 col-sm-3">
                        <div class="img_with_text">
                            ...
                            <h5 class="mt-30 text-bold text-center">Community Engagement</h5>
                            <p class="fz-12 mt-15 text-center equal">An important fabric of ACER is our community
                    ...
                    <div class="col-xs-12 col-md-3 col-sm-3">
                        <div class="img_with_text">
                            <img class="img-responsive" src="<?php echo esc_url(get_template_directory_uri()); ?>/img/leadership_development.jpg">
                                <h5 class="mt-30 text-bold text-center">Leadership Development</h5>
                                <p class="fz-12 mt-15 text-center equal">Through our work, ACER works to develop leaders
                    ...
                    <div class="col-xs-12 col-md-3 col-sm-3">
                            <div class="img_with_text">
                                <img class="img-responsive" src="<?php echo esc_url(get_template_directory_uri()); ?>/img/economic_development.jpg">
                                    <h5 class="mt-30 text-bold text-center">Economic Development</h5>
                                    <p class="fz-12 mt-15 text-center equal">ACER believes economic vitality and independence
                    ...
                    <div class="col-xs-12 col-md-3 col-sm-3">
                            <div class="img_with_text">
                                <img class="img-responsive" src="<?php echo esc_url(get_template_directory_uri()); ?>/img/civic_engagement_education.jpg">
                                    <h5 class="mt-30 text-bold text-center">Civic Engagement and Education</h5>
                                    <p class="fz-12 mt-15 mb-15 text-center equal">ACER understands that when communities
        ...
        <section class="trust-o gray-f9f9-bg">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-6">
                          <img class="img-responsive shadow" src="<?php echo esc_url(get_template_directory_uri()); ?>/img/organisation.jpg">
                         </div>
